  ...
  return (
    <div className="bg-surface rounded-lg p-6 border border-border h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="plate-label ">{t('borrowingCapacity.title')}</h3>
      ...
      <div className="space-y-6 flex-grow overflow-y-auto scrollbar-thin pr-2 min-h-0">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <p
              className={`text-lg font-semibold ${capacity.monthlyIncome > 0 ? 'text-green-500' : 'text-text-primary'}`}
            >
              <ConvertedAmount
          ...
          <div className="space-y-1">
            ...
            <p
              className={`text-lg font-semibold ${capacity.monthlyDebtPayments > 0 ? 'text-red-500' : 'text-text-primary'}`}
            >
              <ConvertedAmount
        ...
        <div className="p-3 bg-surface-elevated border border-border rounded-lg">
          <p className="text-sm text-text-secondary">
            <span className="font-semibold text-primary">{t('borrowingCapacity.insight')}:</span>{' '}
            {getInsightText()}
          </p>
        </div>
      </div>
