            ...
            <div className="flex-1 space-y-2">
              ...
              <ul className="text-sm text-text-secondary space-y-1">
                <li>
                  ...
                  {t('supportedFormats.qif.description')}
                </li>
                <li>
                  <strong>{t('supportedFormats.ofx.name')}</strong> -{' '}
                  {t('supportedFormats.ofx.description')}
                </li>
                <li>
                  <strong>{t('supportedFormats.csv.name')}</strong> -{' '}
                  {t('supportedFormats.csv.description')}
                </li>
                {skroogeJsonEnabled && (
                  <li>
                    <strong>{t('supportedFormats.json.name')}</strong> -{' '}
                    {t('supportedFormats.json.description')}
                  </li>
                )}
              </ul>
            </div>
