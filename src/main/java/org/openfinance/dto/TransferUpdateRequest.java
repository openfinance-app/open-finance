 ...
 * atomically. A transfer
 * consists of two linked transactions (source EXPENSE and destination INCOME)
 * that share a common
...
public class TransferUpdateRequest {
     ...
     *
     * <p>
     * This replaces the original source account. The old source account balance
     * will be reversed
     ...
     *
     * <p>
     * This replaces the original destination account. The old destination account
     * balance will
     ...
     *
     * <p>
     * Must be positive. This amount will be subtracted from the source account and
     * added to the
     * destination account.
     */
     ...
     *
     * <p>
     * Defaults to false. Both sides of the transfer will have the same
