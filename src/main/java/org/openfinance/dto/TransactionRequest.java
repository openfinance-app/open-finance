...
public class TransactionRequest {
    ...
    /**
     * Original (pre-conversion) amount the user entered, in
     * {@link #originalCurrency}. Sent
     * together with {@link #originalCurrency} and {@link #conversionRate} when the
     * entered currency
     * differs from the account currency; otherwise null. All three are validated
     * all-or-nothing.
     */
    @Digits(integer = 26, fraction = 18, message = "{transaction.amount.digits}")
    ...
    /**
     * ISO 4217 currency originally entered (e.g. "USD"). Null when no conversion
     * was applied.
     */
    ...
    /**
     * Applied rate: {@code 1 originalCurrency = conversionRate * currency}. Null
     * when no
     * conversion.
     */
     ...
     *
     * <p>
     * How the transaction was paid: cash, cheque, credit card, debit card, bank
     * transfer,
     ...
     *
     * <p>
     * When set, this transaction (typically EXPENSE) is linked to a loan, mortgage,
     * or other
     * liability. This allows tracking of loan payments and computing the breakdown
     * of principal,
     ...
     *
     * <p>
     * When present, the transaction amount is distributed across the provided split
     * entries. The
     * sum of all split amounts must equal {@code amount} exactly. Splits are only
     * valid for INCOME
     * and EXPENSE transactions — not TRANSFER.
     *
     * <p>
     * Requirement REQ-SPL-2.1: Accept splits on POST
     *
     * <p>
     * Requirement REQ-SPL-2.2: Accept splits on PUT (replace existing)
     *
     * <p>
     * Requirement REQ-SPL-1.5: Splits only for INCOME/EXPENSE
     */
    @Valid
