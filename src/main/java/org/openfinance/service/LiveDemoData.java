...
public class LiveDemoData implements CommandLineRunner {
    ...
    public void seedDemoData() {
        ...
        SecretKey encryptionKey =
                keyManagementService.deriveKey(DEMO_MASTER_PASSWORD.toCharArray(), salt);
    ...
    /**
     * Generates blind-index search tokens for all demo entities so they are discoverable via the
