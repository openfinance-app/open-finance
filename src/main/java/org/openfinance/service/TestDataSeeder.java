...
public class TestDataSeeder implements CommandLineRunner {
        ...
        private void seedAccounts(Long userId) {
                ...
                Institution randomInstitution = institutions.isEmpty()
                                ? null
                ...
                for (int i = accounts.size(); i < base; i++) {
                        ...
                        accounts.add(
                                        createAccount(
                                                        userId, name, type, balance, currency, accNum,
                                                        inst));
                }
        ...
        private void seedLiabilities(Long userId) {
                ...
                for (int i = 0; i < base; i++) {
                        ...
                        // M = P * r(1+r)^n / ((1+r)^n - 1)
                        BigDecimal monthlyRate = interestRateValue.divide(BigDecimal.valueOf(1200), 8,
                        ...
                        if (monthlyRate.compareTo(BigDecimal.ZERO) > 0) {
                                ...
                                minimumPayment = principal.divide(BigDecimal.valueOf(totalMonths), 2,
                                                RoundingMode.HALF_UP);
                        }
        ...
        private void seedTransactions(Long userId) {
                ...
                Account mainChecking = accounts.stream()
                                .filter(
                                                a -> a.getType() == AccountType.CHECKING
