 ...
 *
 * <p>
 * <strong>Scheduled Processing:</strong> The
 * {@link #processRecurringTransactions()} method is
 * called daily by a scheduled job to automatically generate transactions from
 * due recurring
 * templates.
 *
 * <p>
...
public class RecurringTransactionService {
        ...
        public RecurringTransactionResponse createRecurringTransaction(
                ...
                // Save to database
                RecurringTransaction savedRecurringTransaction = recurringTransactionRepository
                                .save(recurringTransaction);
                indexRecurringTxSearchTokens(savedRecurringTransaction, request.getDescription(), request.getNotes());
        ...
        public RecurringTransactionResponse updateRecurringTransaction(
                ...
                RecurringTransaction updatedRecurringTransaction = recurringTransactionRepository
                                .save(recurringTransaction);
                indexRecurringTxSearchTokens(updatedRecurringTransaction, request.getDescription(), request.getNotes());
         ...
         * it
         * re-encrypts data during the transaction creation process using the stored
         * encrypted values
        ...
        private RecurringTransactionResponse toResponseWithDecryption(
                ...
                if (entity.getToAccountId() != null) {
                        toAccountName = accountRepository
        ...
        private void indexRecurringTxSearchTokens(RecurringTransaction rt, String description, String notes) {
                try {
                        ...
                        searchTokenService.indexEntity(rt.getUserId(), "RECURRING_TRANSACTION", rt.getId(),
                                        java.util.List.of(
                                                        new String[] { "description", description },
                                                        new String[] { "notes", notes }),
                                        searchKey);
                } catch (Exception e) {
                        log.warn("Failed to index recurring transaction {} search tokens: {}", rt.getId(),
                                        e.getMessage());
                }
        }
}
