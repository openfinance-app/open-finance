 ...
 *
 * <p>The explicit depth patterns cover all known React Router routes (max 4 segments). Spring's
 * handler mapping gives {@code @RestController} mappings under {@code /api/**} higher priority, so
