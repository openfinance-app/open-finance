...
public class GlobalExceptionHandler {
         ...
         *
         * <p>
         * Thrown when attempting to create or update a simulation with a name that
         * already exists
         ...
         *
         * <p>
         * Introduced in Spring Framework 6.0 to support method-level validation with
         * {@code @Validated} on controller methods. Provides similar functionality to
         * {@link
         * #handleValidationErrors(MethodArgumentNotValidException, WebRequest)} but for
         * method
        ...
        /**
         * Handles client-aborted requests (browser/proxy closed the connection before
         * the response was
         * fully written).
         *
         * <p>
         * This commonly happens on long-running endpoints (e.g. large import
         * confirmation) when the
         * client times out. The server-side work has typically already completed and
         * committed, so this
         * is not an application error. Attempting to write an error response would fail
         * on the already
         * closed socket, so we return {@code null} and log at DEBUG level to avoid
         * noise.
         *
         * @param ex the exception
        ...
        public ResponseEntity<Void> handleClientAbort(
                ...
                log.debug("Client aborted the connection before the response was written: {}", ex.getMessage());
                return null;
        }
         ...
         *
         * <p>
         * Thrown when user-provided input values fail validation checks, such as
         * negative savings,
         ...
         *
         * <p>
         * Thrown when calculation results exceed representable limits, typically with
         * very large
         ...
         *
         * <p>
         * Catches all other calculation-related exceptions that don't have specific
         * handlers. Maps
        ...
        public ResponseEntity<ErrorResponse> handleMissingServletRequestPart(
                ...
                String missingFileMsg = messageSource.getMessage(
