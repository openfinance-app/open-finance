...
public class ImportController {
         ...
         *
         * <p>Use this endpoint to check import progress and session details. The status
         * indicates the
         ...
         *
         * <p>Use this endpoint to cancel an import that is no longer needed. Only
         * sessions in PENDING,
         * PARSED, or REVIEWING status can be cancelled. Sessions that are IMPORTING,
         * COMPLETED, FAILED,
         ...
         *
         * <p>Returns sessions ordered by creation date (most recent first). Includes
         * all sessions
