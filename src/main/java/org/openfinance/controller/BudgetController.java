...
public class BudgetController {
         ...
         *
         * <p>
         * <strong>Request Body:</strong> Same format as create budget. All fields are
         * optional; only
        ...
        public ResponseEntity<BudgetProgressResponse> getBudgetProgress(
                ...
                User user = (User) authentication.getPrincipal();
                BudgetProgressResponse progress = budgetService.calculateBudgetProgress(budgetId, user.getId());
         ...
         * period returns 12
         * rows — one per calendar month — each showing budgeted, spent, remaining,
         * percentage spent,
         ...
         * lookback window,
         * groups EXPENSE transactions by category, computes per-period averages, and
         * flags categories
         ...
         * Duplicate
         * category+period combinations are silently skipped and counted in {@code
         * skippedCount}. Other
        ...
        public ResponseEntity<BudgetBulkCreateResponse> bulkCreateBudgets(
                ...
                User user = (User) authentication.getPrincipal();
                BudgetBulkCreateResponse response = budgetService.bulkCreateBudgets(user.getId(), request.getBudgets());
