...
public class AccountController {
    ...
    public ResponseEntity<AccountResponse> createAccount(
            @Valid @RequestBody AccountRequest request, Authentication authentication) {
    ...
    public ResponseEntity<?> getAllAccounts(
        ...
        if (summary) {
            ...
            List<AccountSummaryResponse> summaries =
                    accountService.getAccountsSummary(user.getId());
        ...
        List<AccountResponse> accounts =
                accountService.getAccountsByUserIdWithFilter(user.getId(), isActiveFilter);
    ...
    public ResponseEntity<Page<AccountResponse>> searchAccounts(
        ...
        Page<AccountResponse> results =
                accountService.searchAccounts(user.getId(), criteria, pageable);
