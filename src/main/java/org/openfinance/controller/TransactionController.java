 ...
 * between accounts. All endpoints require authentication and use the user's
 * encryption key to
...
public class TransactionController {
         ...
         * }</pre>
         *
         * <p><strong>Success Response (HTTP 201 Created):</strong> Returns the source
         * transaction. The
         ...
         * destination INCOME) in
         * a single atomic operation. The transferId in the path identifies the transfer
         * to update.
         *
         * <p><strong>Request Headers:</strong>
         *
         ...
         * }</pre>
         *
         * <p><strong>Success Response (HTTP 200 OK):</strong> Returns the updated
         * source transaction.
        ...
        public ResponseEntity<TransactionResponse> updateTransfer(
                ...
                log.info(
                                ...
                                request.getToAccountId());
                User user = (User) authentication.getPrincipal();
                TransactionResponse response = transactionService.updateTransfer(transferId, user.getId(), request);
        ...
        public ResponseEntity<TransactionResponse> getTransactionById(
                ...
                User user = (User) authentication.getPrincipal();
                TransactionResponse response = transactionService.getTransactionById(transactionId, user.getId());
         ...
         *
         * <p>
         * If no filters are provided, returns all user transactions. Filters can be
         * combined (e.g.,
        ...
        public ResponseEntity<TransactionResponse> updateTransaction(
                ...
                TransactionResponse response = transactionService.updateTransaction(
                                transactionId, user.getId(), request);
         ...
         *
         * <p>Provides flexible search capabilities with multiple optional filters. All
         * filters can be
         ...
         *
         * <p>
         * Returns up to the specified limit of tags, sorted by frequency of use. Useful
         * for tag
        ...
        public ResponseEntity<List<TransactionResponse>> getTransactionsByTag(
                ...
                List<TransactionResponse> transactions = transactionService.getTransactionsByTag(user.getId(), tag);
         ...
         *
         * <p>
         * Returns an empty list if the transaction has no splits. Only the transaction
         * owner can
         * access splits.
         *
         * <p>
