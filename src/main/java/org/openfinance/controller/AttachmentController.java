 ...
 *   <li>Encryption key required via X-Encryption-Session header for file operations
...
public class AttachmentController {
    ...
    public ResponseEntity<Attachment> uploadAttachment(
        ...
        Attachment attachment =
                attachmentService.uploadAttachment(file, userId, entityType, entityId, description);
