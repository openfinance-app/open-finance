 ...
 *
 * <p>
 * Provides endpoints for uploading, downloading, deleting, and listing file
 * attachments
 * associated with financial entities (transactions, assets, real estate,
 * liabilities).
 *
 * <p>
 ...
 * <li>Encryption key required via X-Encryption-Session header for file
 * operations
...
public class AttachmentController {
         ...
         *
         * <p>Validates the file (type, size), encrypts it, stores on filesystem, and
         * creates a database
         ...
         * <li>entityType (required): Entity type (TRANSACTION, ASSET, REAL_ESTATE,
         * LIABILITY)
         ...
         * X-Encryption-Session: a2V5MTIzNDU2Nzg5MA==
         ...
         * @throws IllegalArgumentException if validation fails or encryption key
         * missing
         */
        ...
        public ResponseEntity<Attachment> uploadAttachment(
                ...
                Attachment attachment = attachmentService.uploadAttachment(
                                file, userId, entityType, entityId, description);
         ...
         *
         * <p>
         * Retrieves the encrypted file from filesystem, decrypts it, and streams it to
         * the client
         ...
         *
         * <p>
         * Requirement REQ-2.12.2: Download attachments
         *
         ...
         *
         * <p>
         * Requirement REQ-2.12.3: Delete attachments
         *
         ...
         *
         * <ul>
         * <li>entityType: Filter by entity type (TRANSACTION, ASSET, REAL_ESTATE,
         * LIABILITY)
        ...
        public ResponseEntity<StorageStatsResponse> getStorageStats(Authentication authentication) {
                ...
                StorageStatsResponse stats = new StorageStatsResponse(totalAttachments, totalSizeBytes,
                                totalSizeFormatted);
