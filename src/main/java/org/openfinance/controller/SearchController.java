 ...
 *
 * <p>
 * This controller provides endpoints for searching across all financial
 * entities (transactions,
 * accounts, assets, liabilities, real estate) with both simple and advanced
 ...
 * <li>Advanced search with filters (amount range, date range, accounts,
 * categories, tags, etc.)
...
public class SearchController {
     ...
     *
     * <p>
     * This endpoint searches across all financial entities (transactions, accounts,
     * assets,
     * liabilities, real estate) using the provided keyword. For transactions,
     ...
     * <li><strong>limit</strong> (optional) - Maximum number of results (default:
     * 50, max: 100)
     * </ul>
     *
     * <p>
     ...
     * <li><strong>X-Encryption-Session</strong> - Base64-encoded AES-256 encryption
     * key
     * </ul>
     *
     * <p>
    ...
    public ResponseEntity<GlobalSearchResponse> globalSearch(
            ...
            @RequestParam(value = "limit", required = false, defaultValue = "50") @Min(value = 1, message = "Limit must be at least 1") @Max(value = 100, message = "Limit cannot exceed 100") Integer limit,
     ...
     *
     * <p>
     * This endpoint provides advanced filtering capabilities beyond simple keyword
     * search:
     *
     * <ul>
