 ...
 * land, etc.). All
 * endpoints require authentication and use the user's encryption key to secure
 * sensitive data.
 *
 * <p>
...
public class RealEstateController {
        ...
        public ResponseEntity<RealEstatePropertyResponse> createProperty(
                ...
                RealEstatePropertyResponse response = realEstateService.createProperty(userId, request);
        ...
        public ResponseEntity<Page<RealEstatePropertyResponse>> searchProperties(
                ...
                Page<RealEstatePropertyResponse> results = realEstateService.searchProperties(userId, criteria,
                                pageable);
        ...
        public ResponseEntity<RealEstatePropertyResponse> getPropertyById(
                ...
                Long userId = ControllerUtil.extractUserId(authentication);
                RealEstatePropertyResponse response = realEstateService.getPropertyById(propertyId, userId);
        ...
        public ResponseEntity<RealEstatePropertyResponse> updateProperty(
                ...
                Long userId = ControllerUtil.extractUserId(authentication);
                RealEstatePropertyResponse response = realEstateService.updateProperty(propertyId, userId, request);
         ...
         * inactive for
         * historical tracking purposes. It will no longer appear in default listings or
         * net worth
         * calculations.
         *
         * <p>
         ...
         *
         * <p>Equity represents the portion of the property owned outright (current
         * value - mortgage
        ...
        public ResponseEntity<PropertyEquityResponse> calculateEquity(
                ...
                Long userId = ControllerUtil.extractUserId(authentication);
                PropertyEquityResponse response = realEstateService.calculateEquity(propertyId, userId);
        ...
        public ResponseEntity<PropertyROIResponse> calculateROI(
                ...
                Long userId = ControllerUtil.extractUserId(authentication);
                PropertyROIResponse response = realEstateService.calculateROI(propertyId, userId);
         ...
         * new appraisals,
         * market data, or automated valuation models without updating other property
         * fields.
         *
         * <p><strong>Request Headers:</strong>
         *
        ...
        public ResponseEntity<RealEstatePropertyResponse> estimateValue(
                ...
                Long userId = ControllerUtil.extractUserId(authentication);
                RealEstatePropertyResponse response = realEstateService.estimateValue(propertyId, userId, newValue);
