 ...
 *
 * <p>
 * Provides database access methods for account management including filtering
 * by user, account
...
public interface AccountRepository
         ...
         *
         * <p>
         * This method provides authorization check at the repository level, preventing
         * users from
         ...
         * prevent duplicate
         * plain-text names if encryption is implemented. Consider implementing
         ...
         *
         * <p>
         * Used during transaction import to match transactions to accounts based on the
         * account
         ...
         *
         * <p>
         * Used for batch-loading accounts to avoid N+1 query problems. Callers collect
         * all needed
         * account IDs from a list of entities, then issue a single query here instead
         * of calling {@link
         * #findById} in a loop.
         *
         * <p>
         * Requirement REQ-3.1: Performance – avoid per-row database round-trips
         *
