...
public interface TransactionRepository
         ...
         *
         * <p>
         * Includes transactions where the account is either the source (accountId) or
         * destination
         ...
         *
         * <p>
         * Combines user ownership check with account filtering. Results ordered by
         * transaction date
         * descending.
         *
         * @param userId    the user ID
         ...
         *
         * <p>
         * Used for access control - ensures user can only access their own non-deleted
         * transactions.
         *
         * <p>
         ...
         *
         * <p>
         * Used for category-based reporting and budget tracking. Results ordered by
         * transaction date
         * descending.
         *
         ...
         *
         * <p>
         * Combines user ownership check with category filtering. Results ordered by
         * transaction date
         * descending.
         *
         * @param userId     the user ID
         ...
         *
         * <p>
         * Filter by INCOME, EXPENSE, or TRANSFER. Results ordered by transaction date
         * descending.
         *
         * @param userId the user ID
         ...
         *
         * <p>
         * Used for bank statement reconciliation process. Results ordered by
         * transaction date
         * ascending.
         *
         * @param accountId the account ID
         ...
         * INCOME) that
         * share the same transferId UUID. This query retrieves both transactions for
         * viewing the
         ...
         * Includes transactions where the account is either the source (accountId) or
         * destination
         * (toAccountId) for transfers. Used to prevent deletion of accounts with active
         * transactions.
         *
         * <p>
         ...
         *
         * <p>
         * Used for calculating account balance history over time. Results ordered by
         * transaction
         ...
         *
         * <p>
         * Used for balance recalculation in Java when amount is encrypted.
         *
         ...
         *
         * <p>
         * Used during import duplicate detection (Tier 1 — exact reference match). A
         * non-empty
         * result means the incoming transaction's {@code referenceNumber} (e.g. OFX
         * FITID or QIF check
         * number) matches a previously imported transaction on the same account, so the
         * import
         ...
         *
         * <p>
         * Used to determine whether a payee is "new" (count == 0) for first-time payee
         * anomaly
         * detection.
         *
         * @param userId the user ID
         ...
         *
         * <p>
         * Used to compute per-payee spending statistics (mean and standard deviation)
         * for
         ...
         *
         * <p>
         * Used to compute per-category spending statistics when a transaction has no
         * payee set.
         *
         * @param userId     the user ID
         * @param categoryId the category ID
