 ...
 *
 * <p>
 * Tests all CRUD operations with real HTTP requests, database interactions, and
 * encryption/decryption. Verifies authorization, validation, and calculated
 * fields.
 *
 * @see AssetController
 */
...
class AssetControllerIntegrationTest {
        ...
        void shouldEnforceUserIsolation() throws Exception {
                ...
                LoginRequest bobLogin = LoginRequest.builder()
                                ...
                                .masterPassword("Master123!")
                                .build();
                String bobResp = mockMvc.perform(
                                post("/api/v1/auth/login")
                                                .contentType(MediaType.APPLICATION_JSON)
                ...
                String bobEncKey = objectMapper.readTree(bobResp).get("encryptionKey").asText();
