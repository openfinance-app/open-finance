...
class TransactionControllerTest {
    ...
    void shouldSearchTransactionsByKeyword() throws Exception {
        // Note: Description and notes fields are encrypted, so keyword search only works on
    ...
    @Test
    @DisplayName(
            "GET /api/v1/transactions/{id}/splits - should return 400 when encryption key missing")
    ...
    @Test
    @DisplayName(
            "GET /api/v1/transactions/{id}/splits - should return 400 when encryption key empty")
