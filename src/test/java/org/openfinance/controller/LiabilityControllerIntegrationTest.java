...
/**
 * Integration tests for LiabilityController. Tests all 8 REST endpoints with
 * authentication,
...
class LiabilityControllerIntegrationTest {
        ...
        /**
         * Helper method to create liability directly via repository (for tests that
         * need existing
        ...
        private org.openfinance.entity.Liability createLiabilityDirectly(
                ...
                String encryptedInterestRate = interestRate != null
                                ? encryptionService.encrypt(interestRate.toString(), secretKey)
                                : null;
                String encryptedMinimumPayment = minimumPayment != null
