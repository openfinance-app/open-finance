 ...
 *
 * <p>
 * Tests REST endpoints for AI Assistant functionality with real HTTP requests,
 * authentication,
 * and database interactions. AIProvider is mocked to avoid external API
 * dependency.
 *
 * <p>
 ...
 *
 * <ul>
 * <li>POST /api/v1/ai/chat - Request validation (encryption key, question
 * validation,
 * authentication)
 ...
 *
 * <p>
 * <strong>Note:</strong> The chat endpoint (POST /api/v1/ai/chat) is now
 * synchronous. Business
 * logic for chat, streaming (POST /api/v1/ai/chat/stream SSE), and health check
 * (GET
 * /api/v1/ai/health) is tested at the unit level in AIServiceTest. Conversation
 * CRUD endpoints
                        ...
                        mockMvc.perform(
                                        ...
                                        .andExpect(
                                                        jsonPath("$.messages[1].content")
                                                                        .value("Your net worth is $10,000."))
