 ...
 *
 * <ul>
 * <li>TASK-CAT-3.3.1: Create category → use in transaction → verify auto-fill
 * from payee
 * </ul>
 *
 * <p>
...
class CategoryTransactionFlowIntegrationTest {
        ...
        private Long createCategory(String name, CategoryType type, Long parentId) throws Exception {
                CategoryRequest req = CategoryRequest.builder().name(name).type(type).parentId(parentId).build();
         ...
         *
         * <p>
         * Requirement REQ-2.4.1, REQ-2.3.1
         */
        @Test
         ...
         * create transaction
         * with that payee but NO explicit categoryId → service should auto-fill from
         * payee's default
         * category.
         *
         * <p>
