 ...
 *
 * <p>
 * Tests cover: - GET /api/v1/dashboard - Complete dashboard summary - GET
 * /api/v1/dashboard/accounts - Account summaries - GET
 * /api/v1/dashboard/cashflow - Cash flow
 * analysis - GET /api/v1/dashboard/spending - Spending by category -
 * Authentication and
...
class DashboardControllerIntegrationTest {
        ...
        void shouldGetAccountSummariesSuccessfully() throws Exception {
                ...
                mockMvc.perform(
                                ...
                                .andExpect(
                                                jsonPath("$[0].name").value("Investment Account")) // Highest balance
                                                                                                   // first
