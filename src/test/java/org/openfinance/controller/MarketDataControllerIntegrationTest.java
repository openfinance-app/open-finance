 ...
 *
 * <p>
 * Tests market data retrieval, symbol search, historical prices, and asset
 * price updates. Uses
...
class MarketDataControllerIntegrationTest {
        ...
        void setUp() throws Exception {
                ...
                String assetJson = mockMvc.perform(
                                post("/api/v1/assets")
                                                .header("Authorization", "Bearer " + token)
                                                .header("X-Encryption-Session", encKey)
                                                .contentType(MediaType.APPLICATION_JSON)
        ...
        void shouldUpdateAssetPriceSuccessfully() throws Exception {
                ...
                MarketQuote mockQuote = MarketQuote.builder().symbol("AAPL").price(new BigDecimal("175.50")).build();
