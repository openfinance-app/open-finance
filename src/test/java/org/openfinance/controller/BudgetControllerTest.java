 ...
 *
 * <p>
 * Tests all 7 endpoints: - POST /api/v1/budgets - GET /api/v1/budgets - GET
 * /api/v1/budgets/{id}
 * - PUT /api/v1/budgets/{id} - DELETE /api/v1/budgets/{id} - GET
...
class BudgetControllerTest {
        ...
        void shouldUpdateBudgetSuccessfully() throws Exception {
                ...
                when(budgetService.updateBudget(
                                eq(BUDGET_ID), any(BudgetRequest.class), eq(USER_ID)))
                ...
                verify(budgetService)
                                .updateBudget(eq(BUDGET_ID), any(BudgetRequest.class), eq(USER_ID));
        }
        ...
        void shouldReturn400WhenRequestValidationFailsForSuggestions() throws Exception {
                ...
                BudgetSuggestionRequest invalidRequest = BudgetSuggestionRequest.builder().period(null)
                                .lookbackMonths(6).build();
        ...
        void shouldBulkCreateBudgetsSuccessfully() throws Exception {
                // Given
                BudgetBulkCreateRequest request = BudgetBulkCreateRequest.builder().budgets(Arrays.asList(testRequest))
                                .build();
        ...
        void shouldReturn400WhenRequestValidationFailsForBulkCreate() throws Exception {
                ...
                BudgetBulkCreateRequest invalidRequest = BudgetBulkCreateRequest.builder()
                                .budgets(Collections.emptyList()).build();
