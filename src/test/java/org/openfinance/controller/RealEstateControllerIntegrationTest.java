 ...
 *
 * <p>
 * Tests all CRUD operations, equity/ROI calculations with real HTTP requests,
 * database
 * interactions, and encryption/decryption. Verifies authorization, validation,
 * and calculated
 * fields.
 *
 * <p>
 * Requirement REQ-2.16: Real Estate Management - Full integration testing
 *
...
class RealEstateControllerIntegrationTest {
        ...
        void shouldFailCreateWithoutAuthentication() throws Exception {
                ...
                mockMvc.perform(
                                post("/api/v1/real-estate")
                                                ...
                                                .content(objectMapper.writeValueAsString(req)))
                                .andExpect(
                                                status().isForbidden()); // 403 - Spring Security default for missing
                                                                         // auth
        }
        ...
        void shouldUpdatePropertySuccessfully() throws Exception {
                Long propertyId = createProperty("Old Name", PropertyType.RESIDENTIAL, "500000", "600000", true);
        ...
        void shouldDeletePropertySuccessfully() throws Exception {
                Long propertyId = createProperty("To Delete", PropertyType.RESIDENTIAL, "500000", "600000", true);
