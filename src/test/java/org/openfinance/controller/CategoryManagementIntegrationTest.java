...
/**
 * Integration tests for category management: create, edit, delete, and subcategory handling.
 *
 * <p>Tests cover TASK-CAT-3.3.2:
 *
 * <ul>
...
class CategoryManagementIntegrationTest {
    ...
    /** POST /api/v1/categories - Create a root EXPENSE category. Requirement REQ-2.4.1 */
    @Test
    ...
    /** POST /api/v1/categories - 400 when encryption key header is missing. Requirement REQ-2.18 */
    @Test
    ...
    /** Create a subcategory and verify the parent relationship. Requirement REQ-2.4.2 */
    @Test
    ...
    /**
     * Multiple subcategories should all appear nested under the same parent. Requirement REQ-2.4.2
     */
    @Test
                ...
                .andExpect(
                        jsonPath(
                                ...
                                org.hamcrest.Matchers.hasItems(
                                        subId1.intValue(), subId2.intValue(), subId3.intValue())));
    }

    /**
     * Parent category subcategoryCount must reflect the number of children. Requirement REQ-2.4.2
     */
    @Test
    ...
    /**
     * Deleting a parent category that has subcategories should fail (or the subcategories should be
    ...
    /**
     * Deleting a category that has assigned transactions should be rejected. Requirement REQ-2.4.2
     */
    @Test
    ...
    /**
     * GET /api/v1/categories/tree - must return a structured tree with INCOME and EXPENSE root
