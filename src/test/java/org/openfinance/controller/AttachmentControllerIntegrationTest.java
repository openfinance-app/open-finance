...
class AttachmentControllerIntegrationTest {
        ...
        void shouldListAllUserAttachments() throws Exception {
                ...
                MockMultipartFile file2 = new MockMultipartFile("file", "file2.jpg", "image/jpeg",
                                "content2".getBytes());
        ...
        void shouldNotAccessOtherUsersAttachments() throws Exception {
                ...
                String encKey2 = objectMapper.readTree(resp2).get("encryptionKey").asText();
        ...
        void shouldUploadToAllEntityTypes() throws Exception {
                ...
                // Test ASSET
                MockMultipartFile assetFile = new MockMultipartFile("file", "asset.jpg", "image/jpeg",
                                "asset".getBytes());
                mockMvc.perform(
                                multipart("/api/v1/attachments")
                                                .file(assetFile)
