...
class AccountServiceTest {
        ...
        void shouldValidateNullParametersOnCreate() {
                ...
                assertThrows(
                                ...
                                () -> accountService.createAccount(null, req));
                assertThrows(
                                IllegalArgumentException.class,
        ...
        void shouldSoftDeleteAccount() {
                Account existing = Account.builder().id(7L).userId(3L).name("My Account").isActive(true).build();
        ...
        void shouldThrowWhenDeletingAccountWithTransactions() {
                Account existing = Account.builder().id(5L).userId(2L).name("My Checking").isActive(true).build();
                when(accountRepository.findByIdAndUserId(5L, 2L)).thenReturn(Optional.of(existing));
        ...
        void shouldCalculateBasicBalanceHistory() {
                ...
                // Act
                List<org.openfinance.dto.BalanceHistoryPoint> history = accountService.getAccountBalanceHistory(1L, 1L,
                                "ALL");
        ...
        void shouldCalculateDifferentPeriods() {
                ...
                // Test 1M period
                List<org.openfinance.dto.BalanceHistoryPoint> history1M = accountService.getAccountBalanceHistory(1L,
                                1L, "1M");
                assertThat(history1M).hasSize(2); // opening + transaction

                // Test 3M period
                List<org.openfinance.dto.BalanceHistoryPoint> history3M = accountService.getAccountBalanceHistory(1L,
                                1L, "3M");
                assertThat(history3M).hasSize(2);

                // Test ALL period
                List<org.openfinance.dto.BalanceHistoryPoint> historyALL = accountService.getAccountBalanceHistory(1L,
                                1L, "ALL");
        ...
        void shouldCloseActiveAccountSuccessfully() {
                // Arrange
                Account activeAccount = Account.builder().id(10L).userId(1L).name("Test Account").isActive(true)
                                .build();
        ...
        void shouldHandleAlreadyClosedAccountGracefully() {
                // Arrange
                Account closedAccount = Account.builder().id(11L).userId(1L).name("Test Account").isActive(false)
                                .build();
        ...
        void shouldReopenClosedAccountSuccessfully() {
                // Arrange
                Account closedAccount = Account.builder().id(12L).userId(1L).name("Test Account").isActive(false)
                                .build();
        ...
        void shouldHandleAlreadyActiveAccountGracefully() {
                // Arrange
                Account activeAccount = Account.builder().id(13L).userId(1L).name("Test Account").isActive(true)
                                .build();
        ...
        void shouldPermanentlyDeleteAccountAndTransactions() {
                // Arrange
                Account accountToDelete = Account.builder().id(14L).userId(1L).name("Test Account").isActive(true)
                                .build();
        ...
        void shouldHandlePermanentDeletionWithNoTransactions() {
                // Arrange
                Account accountToDelete = Account.builder().id(15L).userId(1L).name("Test Account").isActive(true)
                                .build();
