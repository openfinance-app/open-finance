 ...
 *
 * <p>Tests CRUD operations, encryption/decryption, validation, authorization, and portfolio
...
class AssetServiceTest {
    ...
    void shouldValidateNullParametersOnCreate() {
        ...
        assertThrows(
                ...
                () -> assetService.createAsset(null, request, testKey));
        assertThrows(
                IllegalArgumentException.class, () -> assetService.createAsset(1L, null, testKey));
        assertThrows(
                IllegalArgumentException.class, () -> assetService.createAsset(1L, request, null));
    }
    ...
    void shouldValidateNullParametersOnUpdate() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> assetService.updateAsset(1L, 1L, null, testKey));
        assertThrows(
                IllegalArgumentException.class,
                () -> assetService.updateAsset(1L, 1L, request, null));
    }
    ...
    void shouldThrowExceptionWhenDeletingNonExistentAsset() {
        ...
        // Act & Assert
        assertThrows(
                AssetNotFoundException.class, () -> assetService.deleteAsset(99L, 1L, testKey));
    ...
    void shouldValidateNullParametersOnDelete() {
        assertThrows(
                IllegalArgumentException.class, () -> assetService.deleteAsset(null, 1L, testKey));
        assertThrows(
                IllegalArgumentException.class, () -> assetService.deleteAsset(1L, null, testKey));
    }
    ...
    void shouldThrowExceptionWhenGettingNonExistentAsset() {
        ...
        // Act & Assert
        assertThrows(
                AssetNotFoundException.class, () -> assetService.getAssetById(99L, 1L, testKey));
    }
    ...
    void shouldValidateNullParametersOnGetById() {
        assertThrows(
                IllegalArgumentException.class, () -> assetService.getAssetById(null, 1L, testKey));
        assertThrows(
                IllegalArgumentException.class, () -> assetService.getAssetById(1L, null, testKey));
    ...
    void shouldGetAssetsByType() {
        // Arrange
        Asset asset =
                Asset.builder().id(1L).userId(1L).type(AssetType.STOCK).name("enc-name").build();
    ...
    void shouldHandlePhysicalAssetWithNullPhysicalFieldsDuringDecryption() {
        ...
        verify(encryptionService, never())
                .decrypt(isNull(), any()); // Should not try to decrypt null values
    }
