 ...
 *
 * <p>
 * Tests cover: - Net worth calculation (assets - liabilities) - Snapshot
 * creation and updates -
 * Historical data retrieval - Monthly change calculation - Edge cases (no data,
 * negative balances,
 * etc.)
 */
...
class NetWorthServiceTest {
        ...
        @Mock
        private org.openfinance.repository.RealEstateRepository realEstateRepository;

        @Mock
        private org.openfinance.repository.RealEstateValueHistoryRepository realEstateValueHistoryRepository;
        ...
        @Mock
        private org.openfinance.repository.TransactionRepository transactionRepository;
        ...
        void shouldCreateNewSnapshotWhenNoneExists() {
                // Arrange
                List<Account> accounts = List.of(createAccount(100L, AccountType.CHECKING, new BigDecimal("5000.00")));

                when(accountRepository.findByUserIdAndIsActive(testUserId, true)).thenReturn(accounts);
                when(netWorthRepository.findByUserIdAndSnapshotDate(testUserId, testDate))
                                .thenReturn(Optional.empty());

                NetWorth savedSnapshot = createNetWorth(
                                1L,
                                testUserId,
                                testDate,
        ...
        void shouldUpdateExistingSnapshotWhenExists() {
                // Arrange
                List<Account> accounts = List.of(createAccount(100L, AccountType.CHECKING, new BigDecimal("7000.00")));

                NetWorth existingSnapshot = createNetWorth(
                                1L,
                                testUserId,
                                testDate,
                                new BigDecimal("5000.00"),
                ...
                NetWorth updatedSnapshot = createNetWorth(
                                1L,
                                testUserId,
                                testDate,
        ...
        void shouldSaveSnapshotForCurrentDate() {
                ...
                List<Account> accounts = List.of(createAccount(100L, AccountType.CHECKING, new BigDecimal("3000.00")));
        ...
        void shouldRetrieveLatestNetWorth() {
                // Arrange
                NetWorth latestSnapshot = createNetWorth(
                                5L,
                                testUserId,
                                testDate,
        ...
        void shouldCalculateMonthlyChangeWithPositiveGrowth() {
                // Arrange
                NetWorth currentSnapshot = createNetWorth(
                                2L,
                                testUserId,
                                testDate,
                                ...
                                BigDecimal.ZERO,
                                new BigDecimal("12000.00"));
                NetWorth previousSnapshot = createNetWorth(
                                1L,
                                testUserId,
