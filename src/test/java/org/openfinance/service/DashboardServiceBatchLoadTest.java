...
/**
 * Unit tests for DashboardService batch loading functionality. Verifies that REQ-3.1 performance
...
class DashboardServiceBatchLoadTest {
    ...
    void getRecentTransactions_withTransfers_includesDestinationAccountIds() {
        ...
        when(accountRepository.findAllByIds(anyCollection()))
                .thenReturn(
                        List.of(createAccount(100L, "Source"), createAccount(200L, "Destination")));
