...
/**
 * Unit tests for TransactionSplitService covering validation, persistence, and
 * retrieval.
 */
...
class TransactionSplitServiceTest {
        ...
        void shouldThrowWhenOnlyOneSplit() {
                // Arrange
                BigDecimal totalAmount = new BigDecimal("100.00");
                List<TransactionSplitRequest> splits = List
                                .of(createSplitRequest(1L, new BigDecimal("100.00"), "desc"));
        ...
        void shouldReturnDecryptedSplitsWithCategoryDenormalization() {
                ...
                List<TransactionSplit> splits = List.of(
                                createSplitEntity(
                                                1L, transactionId, 1L, new BigDecimal("40.00"), "desc1"),
                                createSplitEntity(
                                                2L, transactionId, 2L, new BigDecimal("60.00"), "desc2"));
                ...
                // Act
                List<TransactionSplitResponse> responses = transactionSplitService
        ...
        void shouldHandleNullDescriptionInSplitsRetrieval() {
                ...
                List<TransactionSplit> splits = List
                                .of(createSplitEntity(1L, transactionId, 1L, new BigDecimal("100.00"), null));
        ...
        void shouldHandleSplitsWithoutCategory() {
                ...
                List<TransactionSplit> splits = List
                                .of(createSplitEntity(1L, transactionId, null, new BigDecimal("100.00"), null));
