 ...
 *
 * <p>
 * These tests create a dataset of N records and then measure how long common
 * read/aggregate
 * operations take, verifying that query complexity grows linearly (not
 * exponentially) and that key
 * endpoints remain within acceptable thresholds even with non-trivial data
 * volumes.
 *
 * <p>
 * <b>Dataset sizes and thresholds:</b>
 *
 * <ul>
 ...
 *
 * <p>
 * Requirement: TASK-13.1.6 (Performance tests — bulk operations)
 *
...
class BulkOperationPerformanceTest {
         ...
         *
         * <p>
         * Requirement: TASK-13.1.6 (Bulk account create performance)
         */
        @Test
        ...
        /**
         * Creates {@value #ACCOUNT_COUNT} accounts and then measures how long the list
         * endpoint takes.
         * Verifies no N+1 regression as data grows.
         *
         * <p>
         * Requirement: TASK-13.1.6 (Account list performance with data)
         */
        @Test
        ...
        /**
         * Creates one account then adds {@value #TRANSACTION_COUNT} transactions and
         * asserts both total
         * and per-item SLAs.
         *
         * <p>
         * Requirement: TASK-13.1.6 (Bulk transaction create performance)
         */
        @Test
         ...
         *
         * <p>
         * Requirement: TASK-13.1.6 (Transaction list performance with data)
         */
        @Test
        ...
        /**
         * Seeds {@value #TRANSACTION_COUNT} transactions across multiple accounts and
         * verifies that the
         * dashboard aggregation endpoint still responds within the SLA (no runaway
         * query growth).
         *
         * <p>
         * Requirement: TASK-13.1.6 (Dashboard performance with data)
         */
        @Test
