 ...
 *
 * <p>
 * These tests verify that individual API operations complete within defined SLA
 * thresholds under
 * a clean, single-user test environment backed by an H2 in-memory database.
 * They are not load tests
 * — they validate that the code path itself is not abnormally slow due to N+1
 * queries, missing
 * indices, or synchronous blocking in the service layer.
 *
 * <p>
 * <b>SLA Thresholds (H2 in-memory, single request):</b>
 *
 * <ul>
 ...
 *
 * <p>
 * Requirement: TASK-13.1.6 (Performance tests)
 *
...
class ApiResponseTimeSlaTest {
        ...
        /**
         * Verifies that the login endpoint responds within the SLA. Requirement:
         * TASK-13.1.6
        ...
        /**
         * Verifies that listing accounts responds within the SLA. Requirement:
         * TASK-13.1.6 (Account
         * list performance)
         */
        @Test
        ...
        /**
         * Verifies that creating an account responds within the SLA. Requirement:
         * TASK-13.1.6 (Account
         * create performance)
         */
        @Test
        ...
        /**
         * Verifies that creating a transaction responds within the SLA. Requirement:
         * TASK-13.1.6
        ...
        /**
         * Verifies that listing transactions responds within the SLA. Requirement:
         * TASK-13.1.6
