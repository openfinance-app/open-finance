 ...
 *
 * <p>Requirement REQ-2.2: Account repository tests covering CRUD and custom queries
 */
@DataJpaTest
...
class AccountRepositoryTest {
    ...
    void shouldFindActiveAccountsByUserId() {
        ...
        List<Account> activeAccounts =
                accountRepository.findByUserIdAndIsActive(testUser.getId(), true);
    ...
    void shouldFindAccountsByUserIdAndType() {
        ...
        List<Account> checkingAccounts =
                accountRepository.findByUserIdAndType(testUser.getId(), AccountType.CHECKING);
    ...
    void shouldFindAccountByIdAndUserId() {
        ...
        Optional<Account> found =
                accountRepository.findByIdAndUserId(savedAccount.getId(), testUser.getId());
    ...
    void shouldNotFindAccountWithWrongUserId() {
        ...
        // When
        Optional<Account> found =
                accountRepository.findByIdAndUserId(savedAccount.getId(), wrongUserId);
    ...
    void shouldCheckIfAccountExistsByUserIdAndName() {
        ...
        // When
        boolean exists =
                accountRepository.existsByUserIdAndName(testUser.getId(), "Test Checking Account");
        boolean notExists =
                accountRepository.existsByUserIdAndName(testUser.getId(), "Non-existent Account");
    ...
    void shouldReturnEmptyListWhenFilteringByNonExistentType() {
        ...
        List<Account> investmentAccounts =
                accountRepository.findByUserIdAndType(testUser.getId(), AccountType.INVESTMENT);
